...
<body id="body" style="background-image: url('https://raw.githubusercontent.com/Cowaug/eBotGo/master/src/main/webapp/resources/background.jpg')">
<div style="text-align: center;z-index: 100;padding-top: 48px">
    ...
    %>
    <form style="max-width: 256px;padding: 16px;margin: 0 auto;background:white" class="mdc-elevation--z4" action="${pageContext.request.contextPath}/login" method="post">
